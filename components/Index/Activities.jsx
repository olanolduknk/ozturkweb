...
export default function Activities() {
    ...
    return (
        <div className="pt-5 pb-10 md:grid grid-cols-3 gap-x-6">
            ...
            <div className="flex items-center space-x-5 rounded-lg bg-[#080808] p-5">
                <div className="relative flex items-center w-[100px] h-[100px]">
                <iframe src="https://linkcord.js.org/api/v3/widget/245511350724329473?type=status&theme=dark&background=080808" width="300" height="100" allowtransparency="true" frameborder="0" />
                </div>
            </div>
