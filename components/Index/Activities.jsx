    ...
    return (
        <div className="pt-5 pb-10 md:grid grid-cols-3 gap-x-6">
            <div className="flex items-center space-x-5 rounded-lg bg-[#080808] p-5">
                <div className="relative flex items-center w-[100px] h-[100px]">
                    {!profile ? (
                        ...
                        // profile var ama avatar bilgisi yoksa patlamasın
            ...
            <div className="mt-5 md:mt-0 rounded-lg overflow-hidden col-span-2 w-full h-[140px] sm:gap-x-6 py-5 relative">
                ...
                {profile && (
                    <a onClick={toggle} className="cursor-pointer absolute top-2 left-2 z-[2] uppercase text-xs text-zinc-700">
                        {/* Buraya istersen label koyabilirsin: {type === 'vsc' ? 'Spotify' : 'VSC'} */}
                    </a>
                )}
                ...
                {profile && (
                    <div className="z-1 absolute inset-0">
                        <iframe
                            src={`https://linkcord.js.org/api/v3/widget/245511350724329473?type=${encodeURIComponent(
                                type
                            )}&lang=en&theme=dark&align=left&background=080808`}
                            className="w-full"
                            height="140"
