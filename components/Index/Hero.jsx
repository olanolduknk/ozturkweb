            ...
            <div className="hidden sm:block absolute left-[4%] top-[18%] z-[5]">
                {!profile ? (
                    ...
                    <img
                        src={avatarUrl}
                        alt="Discord Profile"
                        className="w-40 h-40 rounded-full object-cover shadow-xl shadow-black/50 ring-2 ring-white/10"
                    />
                ) : (
                        ...
                        <div className="mr-1.5">
                            <TextLoop>
                                {texts.map((text, index) => (
                                    <Tippy
                                        key={index}
                                        content={<img src={`https://flagcdn.com/20x15/${text.flag}.png`} />}
                                    >
                                        <div className="flex items-center space-x-1">
                                            <h1 style={{ color: text.color }} className="leading-none text-4xl font-bold">
                                                {text.text}
                                            </h1>
                                        </div>
                                    </Tippy>
